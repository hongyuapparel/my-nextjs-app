        ...
        <div className="space-y-6">
          {groupToolsByRows().map((rowTools, rowIndex) => (
            ...
            return (
              <Card
                key={tool.id}
                      className={`group relative overflow-hidden cursor-pointer border-0 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${
                        isActive ? 'ring-2 ring-blue-500 ring-opacity-50 scale-105' : ''
                      }`}
                onClick={() => handleModuleToggle(tool.id)}
              >
                      <div className={`${tool.bgColor} p-6 relative`}>
                  ...
                  <div className={`absolute inset-0 ${tool.gradient} opacity-0 group-hover:opacity-10 transition-opacity duration-300`}></div>
                        ...
                        <div className="relative z-10 flex items-start space-x-4">
                          ...
                          <div className="flex-shrink-0">
                            <div className={`w-16 h-16 rounded-xl ${tool.gradient} flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          ...
                          <div className="flex-1 space-y-3">
                            <div className="space-y-2">
                              <h3 className={`text-lg font-bold ${tool.textColor} group-hover:scale-105 transition-transform duration-300`}>
                        {tool.title}
                      </h3>
